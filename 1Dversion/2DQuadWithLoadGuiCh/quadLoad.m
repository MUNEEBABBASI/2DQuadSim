...
%while tstart < tend,
    ...
    elseif currentMode == 2,
        ...
        %[t, x2] = integrateMode2([tstart tend], [], x20, g, mQ, JQ, kp, kd, kp_phi, kd_phi);
...
function [value, isterminal, direction] = taut(t, x2)
    ...
    x2(1, 1)-x2(5, 1)
    x2(2, 1)-x2(6, 1)
    ((x2(1, 1)-x2(5, 1))^2 + (x2(2, 1)-x2(6, 1))^2)^(1/2)
        value = [ ...
            ((x2(1, 1)-x2(5, 1))^2 + (x2(2, 1)-x2(6, 1))^2)^(1/2); ...%x2(2, 1) - x2(6, 1); ...
        ... %pdist([x2(1, 1), x2(2, 1); x2(5, 1), x2(6, 1)]); ... %when quad and load are at same position
        ];
    isterminal = 1;
    direction = 0;
%     value = [ ...
%         pdist([x2(1, 1), x2(2, 1); x2(5, 1), x2(6, 1)]); ... %when load
%         is above quad
