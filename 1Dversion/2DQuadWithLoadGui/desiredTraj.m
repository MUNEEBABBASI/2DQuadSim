...
%     dtemp = 1;
%     
%     [traj.xT, traj.xTQ, traj.modes, traj.mNew] = findTrajLoad1D(r, n, m, dtemp, tDes, posDes(:, :, 2), TDes, s.g, s.l, s.mL, s.mQ);
%     
%     
%     % look at l
...
%     
%     
%     [~, traj.derivativesX] = evaluateTraj(t, n, 2, dtemp, traj.xT, tDes, r, []);
%     [~, traj.derivativesXQ] = evaluateTraj(t, n, 2, dtemp, traj.xTQ, tDes, r, []);
% end
% 
% 
% 
